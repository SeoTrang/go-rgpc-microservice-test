...
const (
	...
	OrderService_GetAllOrders_FullMethodName = "/main.OrderService/GetAllOrders"
)
...
type OrderServiceClient interface {
	...
	GetAllOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetAllOrders(context.Context, *Empty) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *Empty) (*ListOrderResponse, error) {
