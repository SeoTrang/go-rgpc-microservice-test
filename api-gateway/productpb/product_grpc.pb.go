...
const (
	ProductService_GetProduct_FullMethodName    = "/main.ProductService/GetProduct"
	ProductService_GetAllProduct_FullMethodName = "/main.ProductService/GetAllProduct"
)
...
func (UnimplementedProductServiceServer) GetAllProduct(context.Context, *GetAllProductRequest) (*GetAllProductResponse, error) {
